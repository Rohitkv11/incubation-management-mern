...
function BookingSlots() {
  ...
  const removeCompany = async () => {
    if (applicantId) {
      ...
      const response = await axios.patch(
        "http://localhost:3001/admin/slotDuplicate",
        data
      );
  ...
  const applicants = async () => {
    console.log("kkkkkk");
    const req = await fetch("http://localhost:3001/admin/getApplications");
  ...
  const displaySlots = async () => {
    const req = await fetch("http://localhost:3001/admin/getBookingSlots");
  ...
  const slotBooking = async (id) => {
    ...
    await axios.post(
      "http://localhost:3001/admin/slotUpdate",
      // header:{'Auth':}
      data
    );
  };
